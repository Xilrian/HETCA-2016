...
\caption{Average ($\pm$ SEM) genotypes size in number of LGP statements.}
\label{fig:Size}
\end{figure}
...
\caption{Average ($\pm$ SEM) number of ancestral mutations involved in producing current MCG.}
\label{fig:Mutations}
\end{figure}
...
\caption{Phenotypic comparison average ($\pm$ SEM) $\sigma$: similar environments.}
...
\caption{Phenotypic comparison average ($\pm$ SEM) $\sigma$: dissimilar environments (and SEM).}
\label{fig:similar}
\end{figure}
...
\caption{Average ($\pm$ SEM) phenotypic diversity.}
\label{fig:phenodiv}
\end{figure}
...
\caption{Average ($\pm$ SEM) genotypic diversity.}
\label{fig:genodiv}
\end{figure}
