...
\caption{Size of genotypes in number of LGP statements.}
\label{fig:Size}
\end{figure}
...
\caption{Genotype mutations from initialization to MCG.}
\label{fig:Mutations}
\end{figure}
...
\caption{Phenotypic comparison: dissimilar environments.}
